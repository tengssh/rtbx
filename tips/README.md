...
- [git-bisect](./git-bisect.md): a convenient way to find the source of bugs using Git
- [archive-restore-git-annex-repo](./archive-restore-git-annex-repo.md): how to archive and restore a Git/Git-Annex repository
